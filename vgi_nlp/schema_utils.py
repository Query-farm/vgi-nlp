"""Shared Arrow-schema helpers for the NLP worker.

Keeps column-comment plumbing in one place so every table-in-out function
exposes consistent, documented schemas to DuckDB.
"""
